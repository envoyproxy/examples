...
This demo also shows how you can use custom_tags to to attach additional tags of type literal, request header, environment and metadata to the activate span.
